...
| Q3-C06 | Q2/Q3 代码、产物、metadata 和核心 CSV 属于同一可复现发布版本 | `docs/reproducibility/q2_q3_release_manifest.json`、`q3_dependency_audit.csv`、`q3/run_metadata.json` | q2/q3 pipeline 后由 `tests/test_q2_q3_integration.py` 验证 hash、carry 定义、文档参数和 ODE 复核 | 发布清单证明当前仓库产物一致，不替代真实物理外部验证 | supported |
